...
if [ -z "$TARGET_PATH" ]; then
  ...
  echo "  skills/conciliacao       - Conciliacao automatica de extratos bancarios"
  echo "  skills/rfm-analysis      - Segmentacao RFM + clustering K-Means"
  echo "  workflows/onde-usar-ia   - Diagnostico de implementacao de IA"
  echo "  workflows/cortes-virais  - Cortes virais de entrevistas/podcasts"
  echo ""
  echo "Exemplo:"
